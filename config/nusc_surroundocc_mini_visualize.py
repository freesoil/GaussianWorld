...
seed = 1
print_freq = 1  # More frequent printing for visualization (compared to 50 in eval)
eval_freq = 1
max_epochs = 20
load_from = None
...
resize_lim = [1.0, 1.0]
flip = True
num_frames = 1  # Keep at 1 for mini dataset
temporal_feat_dim = 0
temporal_scale = 1.0
dynamic_scale = 1.0
num_learnable_pts = 6
...
train_dataset_config = dict(
    type='NuScenes_Scene_SurroundOcc_Dataset_Mini',
    data_path = data_path,
...
train_wrapper_config = dict(
    type='NuScenes_Scene_Occ_DatasetWrapper_Mini',
...
train_loader_config = dict(
    batch_size = 1,
    shuffle = True,
    num_workers = 1,  # Reduced from 2 to 1 for visualization
)
